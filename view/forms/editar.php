...
<body>
    ...
    <div class="rectangle11">
        <form action="index.php?u=guardarComentario" method="POST">
            <h2 style="text-align: center;">EDITAR <img src="view/img/editar_logo.png" width="4%">
            </h2>
            <center>
