...
<head>
    ...
    <title>Paraíso En La Selva</title>
                        ...
                        <form id="paraiso">
                            ...
                            <div class="counter-container">
                                ...
                                <form action="index.php?u=agregarProductoAlCarrito">
                                    <button type="button" class="btn_carrito" data-id="paraiso">
            ...
            <tr>
                ...
                <td>
                    <div class="recuadro2_1">
                        ...
                        <br>
                        <img src="view/img/flecha_verde.png" width="20px"> Conductor experimentado y seguro para recorridos en la selva y caminos rurales.
                        <br>
                        <img src="view/img/flecha_verde.png" width="20px"> Entradas a las Lagunas de Montebello y Cascadas El Chiflón.
                        <br>
                        <img src="view/img/flecha_verde.png" width="20px"> Seguro de viajero en transporte y actividades dentro de las áreas turística.
                        <br>
