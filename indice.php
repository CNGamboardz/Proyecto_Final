...
<body>
    ...
    <section class="tours">
        ...
        <table width="100%" class="tabla_tours">
            <tr> 
                    <td><img src="view/img/p1.jpg" alt="" idth="400" height="370"></td>
                    <td><img src="view/img/p2.jpg" alt="" idth="400" height="370"></td>
                    <td><img src="view/img/p3.jpg" alt="" idth="400" height="370"></td>
            </tr>
        </table>
        <br>
        <br>
        ...
        <table width="100%" class="tabla_paquetes">
            <tr> 
                    <td><img src="view/img/20.jpg" alt="" idth="400" height="370"></td>
                    <td><img src="view/img/19.jpg" alt="" idth="400" height="370"></td>
                    <td><img src="view/img/13.jpg" alt="" idth="400" height="370"></td>
            </tr>
        </table>
    </section>
</body>
